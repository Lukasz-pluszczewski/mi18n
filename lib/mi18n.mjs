...
logger.translations = function () {
  ...
  return (_console = console).log.apply(_console, ['mi18n'].concat(args));
};
...
var actionType$1 = SET_LANGUAGE;

var setLanguage$$1 = setLanguage$1;
var reducer$$1 = reducer$1;
var actionType$$1 = actionType$1;

export { setLanguage$$1 as setLanguage, reducer$$1 as reducer, actionType$$1 as actionType };export default getT$1;
