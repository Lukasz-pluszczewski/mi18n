...
var translatorFactory = {
  ...
  getTranslator: function getTranslator(state, translatorNamespace) {
    ...
    if (translatorFactory.cachedState && state.languageCode === translatorFactory.cachedState.languageCode && state.cachedState === state) {
...
exports.setLanguage = setLanguage$$1;
